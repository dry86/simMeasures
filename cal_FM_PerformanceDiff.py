...
if __name__ == "__main__":
    ...
    model_2 = "/newdisk/public/wws/model_dir/deepseek-coder/dsc-7b-base-v1.5" #  不同源模型

    # 打开jsonl文件并遍历
    file_path = '/newdisk/public/wws/Dataset/humaneval-x-main/data/python/data/humaneval.jsonl'  # Dataset
