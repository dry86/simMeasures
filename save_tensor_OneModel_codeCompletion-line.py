...
def main(model1_path, model_idx, padding_len, lang, device1, batch_size=1):
    ...
    data_file_path = f"/newdisk/public/wws/Dataset/CodeCompletion-line/dataset/{lang}/line_completion/test.json"

    save_dir = model_path + "/pt_file" + "/line_completion/" +  lang + "/"
