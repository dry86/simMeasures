...
def main():
    # 加载模型和tokenizer
    device = torch.device("cuda:2")  # 使用第0块GPU
    model_path = "/newdisk/public/wws/model_dir/codellama/codeLlama-7b"
    model, tokenizer = load_model_and_tokenizer(model_path, device)

    # 定义文件路径
    problem_file = "/newdisk/public/wws/simMeasures/human_eval/HumanEval.jsonl"
    sample_file = "/newdisk/public/wws/simMeasures/human_eval/generated_samples.jsonl"
